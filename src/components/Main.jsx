      ...
      <section className="main__form">
        <form
          ...
          onSubmit={(event) => {
            ...
            // @ts-ignore
            let bestFeatures = Array.from(event.target.bestFeatures)
              .filter((input) => input.checked)
              .map((input) => input.value);
            // @ts-ignore
            let worstFeatures = Array.from(event.target.worstFeatures)
              .filter((input) => input.checked)
              .map((input) => input.value);

            // @ts-ignore
            let timeSpent = Array.from(event.target.timespent)
              .filter((input) => input.checked)
              .map((input) => input.value);
        ...
        >
          ...
          <div className="form__group">
            ...
            <ul>
              ...
              <li>
                <label>
                  <input name="timespent" type="checkbox" value="I'dont want" />
                  I dont like to spend time with
                </label>
              </li>
            </ul>
          </div>
